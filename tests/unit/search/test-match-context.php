<?php
/**
 * Unit tests for the Context classes.
 *
...
class MatchContextTest extends TestCase {
	...
	public function testContextMatched() {
		$context = new Context\Type\Matched( 'value', 'label' );

		$this->assertTrue( $context->is_matched() );
		// Matched extends Value which uses base Context::needs_saving() returning false
		$this->assertFalse( $context->needs_saving() );
	}
	...
	public function testContextText() {
	...
	public function testContextTextEquals() {
	...
	public function testContextValueDefaultLabel() {
		$context = new Context\Type\Value( 'test_value' );

		$this->assertEquals( 'test_value', $context->to_json()['value_label'] );
	}

	public function testContextAddJson() {
		$context = new Context\Type\Add( 'new_value', 'new_label' );
		$json = $context->to_json();

		$this->assertEquals( 'add', $json['type'] );
		$this->assertEquals( 'new_value', $json['value'] );
		$this->assertEquals( 'new_label', $json['value_label'] );
	}

	public function testContextDeleteJson() {
		$context = new Context\Type\Delete( 'old_value', 'old_label' );
		$json = $context->to_json();

		$this->assertEquals( 'delete', $json['type'] );
		$this->assertEquals( 'old_value', $json['value'] );
		$this->assertEquals( 'old_label', $json['value_label'] );
	}
}
