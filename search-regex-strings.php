...
__( "Search Regex", "search-regex" ), // client/page/home/index.js:27
__( "Options", "search-regex" ), // client/page/home/index.js:28
__( "Support", "search-regex" ), // client/page/home/index.js:29
__( "Presets", "search-regex" ), // client/page/home/index.js:30
__( "Search & Replace", "search-regex" ), // client/page/home/index.js:36
...
__( "I'm a nice person and I have helped support the author of this plugin", "search-regex" ), // client/page/options/options-form.js:57
__( "Actions", "search-regex" ), // client/page/options/options-form.js:62
__( "Show row actions as dropdown menu.", "search-regex" ), // client/page/options/options-form.js:70
__( "Default Preset", "search-regex" ), // client/page/options/options-form.js:74
__( "No default preset", "search-regex" ), // client/page/options/options-form.js:77
__( "Set a preset to use by default when Search Regex is loaded.", "search-regex" ), // client/page/options/options-form.js:84
...
__( "Source Flags", "search-regex" ), // client/page/preset-management/preset-edit.js:72
__( "Results per page", "search-regex" ), // client/page/preset-management/preset-edit.js:76
__( "Edit preset", "search-regex" ), // client/page/preset-management/preset-edit.js:119
__( "Preset Name", "search-regex" ), // client/page/preset-management/preset-edit.js:123
__( "Give the preset a name", "search-regex" ), // client/page/preset-management/preset-edit.js:129
__( "Preset Description", "search-regex" ), // client/page/preset-management/preset-edit.js:134
__( "Describe the preset", "search-regex" ), // client/page/preset-management/preset-edit.js:140
__( "Advanced preset", "search-regex" ), // client/page/preset-management/preset-edit.js:153
__( "Locked Fields", "search-regex" ), // client/page/preset-management/preset-edit.js:157
__( "Fields", "search-regex" ), // client/page/preset-management/preset-edit.js:164
__( "Locking a field removes it from the search form and prevents changes.", "search-regex" ), // client/page/preset-management/preset-edit.js:168
__( "Tags", "search-regex" ), // client/page/preset-management/preset-edit.js:172
__( "Title", "search-regex" ), // client/page/preset-management/preset-edit.js:177
__( "Enter tag title shown to user", "search-regex" ), // client/page/preset-management/preset-edit.js:180
__( "Tag", "search-regex" ), // client/page/preset-management/preset-edit.js:187
__( "Enter tag which is used in the field", "search-regex" ), // client/page/preset-management/preset-edit.js:190
__( "A tag creates a custom input field. Insert the tag anywhere in the search or replace field and when the preset is used it will be replaced with a custom text field with the tag label.", "search-regex" ), // client/page/preset-management/preset-edit.js:210
...
__( "Search", "search-regex" ), // client/page/search-replace/search-form/form.js:93
__( "Search Flags", "search-regex" ), // client/page/search-replace/search-form/form.js:109
__( "Replace", "search-regex" ), // client/page/search-replace/search-form/form.js:132
__( "Enter global replacement text", "search-regex" ), // client/page/search-replace/search-form/form.js:138
__( "Enter global replacement text", "search-regex" ), // client/page/search-replace/search-form/form.js:150
__( "Source", "search-regex" ), // client/page/search-replace/search-form/form.js:157
__( "Source Options", "search-regex" ), // client/page/search-replace/search-form/form.js:187
__( "Results", "search-regex" ), // client/page/search-replace/search-form/form.js:200
...
__( "Your REST API is probably being blocked by a security plugin. Please disable this, or configure it to allow REST API requests.", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:86
__( "Read this REST API guide for more information.", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:92
__( "Your REST API is returning a 404 page. This is almost certainly an external plugin or server configuration issue.", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:104
__( "Can you access your {{api}}REST API{{/api}} without it redirecting? If not then you will need to fix any issues.", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:110
__( "Check your {{link}}Site Health{{/link}} and fix any issues.", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:120
__( "Your server configuration is blocking access to the REST API. You will need to fix this.", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:127
__( "A security plugin or firewall is blocking access. You will need to whitelist the REST API.", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:132
__( "Read this REST API guide for more information.", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:139
__( "Your REST API is being redirected. Please remove the redirection for the API.", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:147
__( "Your server has rejected the request for being too big. You will need to reconfigure it to continue.", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:153
__( "An unknown error occurred.", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:161
__( "This could be a security plugin, or your server is out of memory or has an external error. Please check your server error log", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:169
__( "Read this REST API guide for more information.", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:175
__( "Your WordPress REST API has been disabled. You will need to enable it to continue.", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:183
__( "WordPress returned an unexpected message. This could be a PHP error from another plugin, or data inserted by your theme.", "search-regex" ), // client/wp-plugin-components/error/decode-error/index.js:193
