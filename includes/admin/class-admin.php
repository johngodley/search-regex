...
class Admin {
	...
	public function __construct() {
		...
		register_uninstall_hook( SEARCHREGEX_FILE, [ self::class, 'plugin_uninstall' ] );
	}
	...
	<div class="react-error" style="display: none">
		...
		<p><?php echo wp_kses( __( 'Also check if your browser is able to load <code>search-regex.js</code>:', 'search-regex' ), [ 'code' => [] ] ); ?></p>
		...
		<p><?php echo wp_kses( __( 'Please see the <a href="https://searchregex.com/support/problems/">list of common problems</a>.', 'search-regex' ), [ 'a' => [ 'href' => [] ] ] ); ?></p>
		<p><?php esc_html_e( 'If you think Search Regex is at fault then create an issue.', 'search-regex' ); ?></p>
		<p class="versions"><?php echo wp_kses( __( '<code>SearchRegexi10n</code> is not defined. This usually means another plugin is blocking Search Regex from loading. Please disable all plugins and try again.', 'search-regex' ), [ 'code' => [] ] ); ?></p>
		<p>
