...
function DatabaseError( props: DatabaseErrorProps ) {
	const { error, onClear } = props;
	const debug = error.jsonData;
	const email =
		'mailto:john@searchregex.com?subject=Search%20Regex%20Query%20Error&body=' + encodeURIComponent( debug );
	const github =
	...
	return (
		<div className="wpl-error">
			<div className="closer" onClick={ onClear } onKeyDown={ onClear } role="button" tabIndex={ 0 }>
